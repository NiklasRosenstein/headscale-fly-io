...
| `LITESTREAM_ENABLED`                             | `true`                            | Whether Litestream replication is enabled. It is highly recommended to keep this enabled, however you may need to temporarily turn it off to perform a migration to Headscale on Fly.io.                                                                                                           |
