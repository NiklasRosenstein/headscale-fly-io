...
| `HEADSCALE_OIDC_CLIENT_ID`                       | n/a                               | The OIDC client ID.                                                                                                                                                                                                                                                                                |
| `HEADSCALE_OIDC_CLIENT_SECRET`                   | n/a                               | The OIDC client secret. **Important:** Configure this through `fly secrets set`.                                                                                                                                                                                                                   |
